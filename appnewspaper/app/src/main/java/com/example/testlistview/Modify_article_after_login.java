...
public class Modify_article_after_login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button chooseImagen = findViewById(R.id.chooseImagen);
        ...
        try {
            ...
            imageView = findViewById(R.id.imageModify);
            ...
            //
            Button saveArticleModify = findViewById(R.id.saveModify);
            ...
            Button cancelArticleModify = findViewById(R.id.cancelModify);
