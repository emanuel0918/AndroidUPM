...
/**
 * Adapted to adapt tha data of list articles to show in te listview
 */
public class MyAdapter extends ArrayAdapter<Article> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //If I click on the element of the lisy I am going to see the detail of the article
        ...
        deleteListArticle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Dialalog to show if i want to delete the article
