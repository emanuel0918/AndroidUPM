...
public class PublishArticleFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        //Show the information of the list of the articles
        ...
        ((Button)getView().findViewById(R.id.publish_new_btn)).setEnabled(false);
            ...
            if (!((title_form.getText().toString().equals("")) &&
                ...
                try {
                    ...
                    b64Image = null;
                    //Add new new image to the article
                    try {
                ...
                //It is checked if there is some field without information mandatory
                ...
                //Feedback when some mandatory filled is not filled
    ...
    /**
     * Chceck is network availbale to load the articles of DB or  the server
     * @return
     */
    ...
    /**
     * Reload articles in the main screen, on the list of articles
     */
